-- Fixed function to create session-based stock reservations
-- Adapted to work with existing stock_reservations table schema
...
BEGIN
    ...
    -- Create reservation with only the columns that exist in the table

...
const HomePage: React.FC = () => {
  ...
  const { showrooms, settings, fetchShowrooms } = useSettingsStore()
  ...
  const promotionalOffers = [
    {
      ...
      bgColor: '#FF6B6B',
      icon: <OfferIcon />,
      action: () => navigate('/categorii_produse/gresie'),
    ...
    <Box sx={{ m: -3 }}>
      ...
      >
        <Container maxWidth="md">
          ...
          >
            {/* Facebook */}
            {showrooms.length > 0 && settings.social_facebook_url && (
            <Box
              component="a"
            ...
            {/* Instagram */}
            {showrooms.length > 0 && settings.social_instagram_url && (
            <Box
              component="a"
            ...
            {/* YouTube */}
            {showrooms.length > 0 && settings.social_youtube_url && (
            <Box
              component="a"
            ...
            {/* TikTok */}
            {showrooms.length > 0 && settings.social_tiktok_url && (
            <Box
              component="a"
